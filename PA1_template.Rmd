...
```
The 5-minute interval "`r df.max$interval`" , on average across all the days in the dataset, contains the maximum number of steps `r as.integer(df.max$steps.mean)`
